...
use mlkem::MlKem768X25519KexType;
...
/// `mlkem768x25519-sha256`（OpenSSH 9.9+ 默认的后量子混合 KEX）。
pub const MLKEM768_X25519: Name = Name("mlkem768x25519-sha256");
...
const _MLKEM768_X25519: MlKem768X25519KexType = MlKem768X25519KexType {};
...
pub(crate) static KEXES: Lazy<HashMap<&'static Name, &(dyn KexType + Send + Sync)>> =
    Lazy::new(|| {
        ...
        h.insert(&MLKEM768_X25519, &_MLKEM768_X25519);
